...
{
	public abstract partial class Pool<TPoolable> : Node2D, IEnumerable<TPoolable>
	...
	public abstract partial class Pool<TPoolable, TCategory> : Node2D, IEnumerable<TPoolable>
		where TPoolable : IPoolable
	{
